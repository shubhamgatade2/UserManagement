...
<body>
  <form class="modal-content" action="register" method="post">
    <div class="container">
      ...
      <input type="text" placeholder="Enter First Name" name="firstname" pattern="[A-Z]{1}[a-z]{2,9}" title="First letter must be capital" required>

	  <label for="lastname"><b>Last Name</b></label>
      <input type="text" placeholder="Enter Last Name" name="lastname" pattern="[A-Z]{1}[a-z]{2,9}" title="First letter must be capital" required>

	  <label for="email"><b>Email Address</b></label>
      <input type="email" placeholder="Enter Email Address" name="emailaddress" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
